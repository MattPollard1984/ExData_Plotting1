...
with(dataIn, plot(DateTime, Global_active_power, type="n", ylab="Global Active Power", xlab=""))
...
##************************************************************************
## Draw base for plot (type=n)
##      Include X and Y-axis title
with(dataIn, plot(DateTime, Voltage, type="n", ylab="Voltage", xlab="datetime"))

## Add in the lines, with type = "l" to join them with a line
with(dataIn, lines(DateTime, Voltage, type="l"))
...
## Draw base for plot (type=n)
##      Include X and Y-axis title
with(dataIn, plot(DateTime, Global_reactive_power, type="n", ylab="Global_reactive_power", xlab="datetime"))

## Add in the lines, with type = "l" to join them with a line
with(dataIn, lines(DateTime, Global_reactive_power, type="l"))
